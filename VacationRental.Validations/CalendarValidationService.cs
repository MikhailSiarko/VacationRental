...
{
    public class CalendarValidationService : BaseValidationService, ICalendarValidationService
    {
        public CalendarValidationService(IStorage<int, Rental> rentals) : base(rentals)
        {
        }
